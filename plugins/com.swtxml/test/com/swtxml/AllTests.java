...
@Suite.SuiteClasses( { SplitterTest.class, ProposalsTest.class, ReflectorTest.class,
		...
		ConstantParserTest.class, KeyValueParserTest.class, FormAttachmentTypeTest.class,
		ContextTest.class, SwtTypesTest.class, SwtInjectorTest.class, SwtNamespaceTest.class,
